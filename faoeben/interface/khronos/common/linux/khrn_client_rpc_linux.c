...
=============================================================================*/
#include "interface/vchiq_arm/vchiq.h" /* pulls in interface/vchiq_arm/vchiq_if.h */
...
{  
   ...
   VCHIQ_STATUS_T khan_return = 0;
   VCHIQ_STATUS_T khrn_return = 0;
   VCHIQ_STATUS_T khhn_return = 0;
...
/*not identical but copies old code*/
#define CTRL_THRESHOLD 2032
