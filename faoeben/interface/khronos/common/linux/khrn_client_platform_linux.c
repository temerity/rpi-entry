...
/*
new
static bool have_default_dwin[5];
static EGL_DISPMANX_WINDOW_T default_dwin[5];
old
*/
#define NUM_WIN 6
...
/*new*/
static EGL_DISPMANX_WINDOW_T *new_check_default(EGLNativeWindowType win)
{
   int wid = (int)win;
   if(wid>=-4 && wid <=0) {
      /*
       ...
       * win == 0 => full screen 800x480 window
       * win == -1 => 1/4 screen 400x240 top left window
       * win == -2 => 1/4 screen 400x240 top right window
       * win == -3 => 1/4 screen 400x240 bottom left window
       * win == -4 => 1/4 screen 400x240 bottom right window
      ...
      if (!have_default_dwin[wid]) {
         ...
         {
         case 1:
            x = 0; y = 0; width = 400; height = 240; layer = 0; break;
         case 2:
            x = 400; y = 0; width = 400; height = 240; layer = 0; break;
         case 3:
            x = 0; y = 240; width = 400; height = 240; layer = 0; break;
         case 4:
            x = 400; y = 240; width = 400; height = 240; layer = 0; break;
         case 0:
            x = 0; y = 0; width = 800; height = 480; layer = 0;  break;
         }
