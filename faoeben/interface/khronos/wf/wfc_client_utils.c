...
static void wfc_source_or_mask_destroy_actual(WFC_SOURCE_OR_MASK_T *source_or_mask_ptr)
{
   ...
   if(source_or_mask_ptr->refcount == 0)
   {
      //logging_message(LOGGING_WFC, "wfc_source_or_mask_destroy_actual %d", (uint32_t) source_or_mask_ptr);
   ...
   {
      //logging_message(LOGGING_WFC, "wfc_source_or_mask_destroy_actual: pending %d", (uint32_t) source_or_mask_ptr); 
   } // else
